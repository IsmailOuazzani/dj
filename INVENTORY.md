...
| Adafruit 5346 MCP23017 STEMMA QT breakout | 2 | https://www.digikey.ca/en/products/detail/adafruit-industries-llc/5346/15913270 | I²C GPIO expander at 0x20 (A0/A1/A2 straps un-bridged). Adds 16 GPIO for button scanning. STEMMA QT sockets on both edges. 1st delivered 2026-07-10; 2nd on hand as of 2026-09-05 (order date not logged). ⚠️ Both default to 0x20 — bridge `A0` on the second before putting both on one bus. |
...
| Same Sky PT01-D115D-B103 rotary pot (10 kΩ B-taper, 6 mm D-shaft) | 14 | https://www.digikey.ca/en/products/result?keywords=PT01-D115D-B103 | Panel-mount pots for EQ / cue / master / hp / FX-level positions. Linear taper, no detent — the SPEC-preferred detent-filter variant (PT01-D225D-B103) is not in this batch. Covers the 12-pot v1 layout with 2 spares. Delivered 2026-07-10 (+3 delivered 2026-08-08). |
| Same Sky PTNS2-6015M-B10 slider (60 mm, 10 kΩ B-taper) | 7 | https://www.digikey.ca/en/products/result?keywords=PTNS2-6015M-B10 | v0-mock tempo + channel-volume sliders (v1 pitch faders are Bourns PTL01, still to buy). ⚠ **2.5 mm metric pin pitch — will NOT drop into 0.1" breadboard cleanly**. Solder hookup-wire pigtails before mounting. Metal-lever cutout is 4.0 × 1.2 mm — no on-shelf Digikey CA cap fits without light filing (Davies 1300-B slot is 3.6 × 1.1 mm); run bare for v0. Delivered 2026-07-10 (+3 delivered 2026-08-08). |
| E-Switch TL1105SPF160Q tactile (6 × 6 mm, 160 gf, 100k cycles) | 25 | https://www.digikey.ca/en/products/detail/e-switch/TL1105SPF160Q/271558 | Original panel-tactile plan — **superseded by the Adafruit 3430/1/2/3 arcade-button family below** (too small to feel good in the 1/4" panel). Retained as bench proxies for prototyping and any small-button role that survives the redesign. Delivered 2026-07-10. |
...
| Cliff CL170822BR knob (soft-touch, 6 mm D-shaft, push-fit + set screw) | 12 | https://www.digikey.ca/en/products/result?keywords=4654-CL170822BR-ND | Panel knobs for the 12 pots. Fits Bourns PEC11R `F`-suffix flatted encoder shaft too. Delivered 2026-07-10 (+11 delivered 2026-08-08). 4 short of the 16 v1 need (12 pots + 4 non-jog encoders). |
...
| Adafruit 3433 illuminated arcade button — 24 mm, green (5V LED w/ integrated ~1kΩ resistor, momentary SPST-NO, quick-connect 0.110" tabs, fits panels ≤15 mm thick) | 16 | https://www.digikey.ca/en/products/detail/adafruit-industries-llc/3433/8119804 | Primary panel-button family — supersedes the TL1105 + 1RBLK plan. 24 mm cutout fits 1/4" (6.35 mm) panel comfortably. Green is the dominant color; assign per color-coding scheme once decided. LED needs 5V rail — plan whether wired always-on or driven per-button (per-button = another MCP23017 or shift-register). Delivered 2026-08-08. |
| Adafruit 3430 illuminated arcade button — 24 mm, red | 4 | https://www.digikey.ca/en/products/detail/adafruit-industries-llc/3430/7349492 | Same body/LED spec as 3433 — for color-coded slots (cue / load / record / etc). Delivered 2026-08-08. |
| Adafruit 3431 illuminated arcade button — 24 mm, yellow | 4 | https://www.digikey.ca/en/products/detail/adafruit-industries-llc/3431/7349493 | Same body/LED spec as 3433. Delivered 2026-08-08. |
| Adafruit 3432 illuminated arcade button — 24 mm, blue | 4 | https://www.digikey.ca/en/products/detail/adafruit-industries-llc/3432/7349494 | Same body/LED spec as 3433. Delivered 2026-08-08. |
| Adafruit 3720 solar digital calipers (0–100 mm, 0.1 mm resolution) | 1 | https://www.digikey.ca/en/products/result?keywords=1528-2555-ND | **Tool, not a build component.** For measuring panel cutouts, actuator posts, lever blades, knob shafts when verifying fitment. Delivered 2026-08-08. |
...
3. **Phase 3 — Scaling I/O (covered for v0):** CD4067 mux + 2 × MCP23017 expander on hand. Full v1 needs 1 more MCP23017 breakout (3 total) for all 27 buttons.
...
- 2 center-detent filter pots `2223-PT01-D225D-B103-ND` https://www.digikey.ca/en/products/result?keywords=PT01-D225D-B103 — the 14 PT01 on hand are all linear, no detent yet.
...
- 1 more MCP23017 breakout for the full 27-button v1 (have 2, need 3 total) `1528-5346-ND` https://www.digikey.ca/en/products/detail/adafruit-industries-llc/5346/15913270.
- 2 more 4.7 kΩ resistors + 2 more 0.1 µF caps for the second I²C bus + per-MCP decoupling.
- 4 more Cliff CL170822BR knobs (12 on hand, 16 needed for 12 pots + 4 non-jog encoders).
- USB-B (or USB-C) panel-mount jack + cable for the enclosure.
- Enclosure material.
- **BOM.md refresh** — panel-button pivot to Adafruit 24 mm arcade family (3430/1/2/3) obsoletes the TL1105+1RBLK line and shifts per-button cost from ~$0.78 to $2.50. Retotal against the $300 SPEC cap next BOM pass.
